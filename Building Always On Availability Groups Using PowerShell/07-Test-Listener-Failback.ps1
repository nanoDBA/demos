...
$targetOwnerNode = $primaryReplica ;
$startTest = Get-Date; 
...
$paramHash = @{
Â Â Source = $Source
Â Â Â Destination = $Destination
Â Â Â Database = $Database
Â Â Â BackupRestore = $True
Â Â Â UseLastBackup = $True
Â Â Â #NoRecovery = $True
}
